...
public class FavDatumAdapter extends RecyclerView.Adapter<FavDatumAdapter.DataObjectHolder> {
    ...
    // Constructors
    public FavDatumAdapter(Context con) {
        m_context = con;
    ...
    public FavDatumAdapter(Context con, ArrayList<Datum> data) {
        m_context = con;
        m_data    = data;
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        starButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addFavourites(starButton, dataObjectHolder.ind.getText()+"", dataObjectHolder.pos.getText()+"");
            }
        });
    ...
    private void addFavourites(ImageButton starButton, String index, String pos) {

        SharedPreferences SPFavourites = m_context.getSharedPreferences("Favourites", MODE_PRIVATE);
        SharedPreferences SPBooks = m_context.getSharedPreferences("Books", MODE_PRIVATE);
